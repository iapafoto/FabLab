...
rotate(-90) {
    intersection() {
        translate([0,-31,0]) rotate(45) pales(lTige,lPale,wPale,epPale,z=3);
        translate([0,-31,-200])sphere(203+3*epPale,$fn=100);
    }

    rotate(90,[1,0,0])
    difference() {
        scale([1,.3,1]) moulin(false);
